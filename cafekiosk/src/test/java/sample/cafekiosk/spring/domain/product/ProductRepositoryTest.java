...
class ProductRepositoryTest extends IntegrationTestSupport {
    ...
    void findAllBySellingStatusIn() {
        ...
        //when
        List<Product> products = productRepository.findAllByProductSellingStatusIn(List.of(ProductSellingStatus.SELLING,
    ...
    void findLatestProductNumber() {
        ...
        Product product1 = createProduct("001", ProductType.HANDMADE, ProductSellingStatus.SELLING, "아메리카노", 4000);
        Product product2 = createProduct("002", ProductType.HANDMADE, ProductSellingStatus.HOLD, "카페라떼", 4500);
        Product targetProduct = createProduct("003",
                                                    ProductType.HANDMADE,
                                                    ProductSellingStatus.STOP_SELLING,
                                                    "팥빙수",
                                                    7000);

        productRepository.saveAll(List.of(product1, product2, targetProduct));
        //when
        String productNumber = productRepository.findLatestProductNumber();

        //then
        assertThat(productNumber).isEqualTo(targetProduct.getProductNumber());
    }
